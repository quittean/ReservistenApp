...
export default class LinkKompetenzzentrumOrgaScreen extends Component {
    render() {
        return (
        <WebView
            source={{uri: 'https://www.bundeswehr.de/de/ueber-die-bundeswehr/die-reserve-der-bundeswehr/organisation-der-reserve-der-bundeswehr/kompetenzzentrum-fuer-reservistenangelegenheiten-der-bundeswehr'}}
            ...
            removeElementsByTwoHeading("Mehr zum Thema:&nbsp;Kompetenzzentrum für Reservistenangelegenheiten der Bundeswehr", main);
            removeElementsByTwoHeading("Strategie der Reserve", main);
