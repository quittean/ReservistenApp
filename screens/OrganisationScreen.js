  ...
  render() {
    return (
      ...
      <View style={{alignItems: 'center', justifyContent: 'center' }}>
        ...
        <View>
          <Text style={{paddingTop:10,paddingLeft:20,paddingRight:5,color:'white', fontSize:17,textAlign:'left'}}>der Bundeswehr,</Text>
          <Text style={{paddingTop:10,paddingLeft:20,paddingRight:5,color:'white', fontSize:17,textAlign:'left'}}>den Reservistinnen und Reservisten,</Text>
          <Text style={{paddingTop:10,paddingLeft:20,paddingRight:5,color:'white', fontSize:17,textAlign:'left'}}>den Arbeitgeberinnen und Arbeitgebern sowie</Text>
          <Text style={{paddingTop:10,paddingLeft:20,paddingRight:5,color:'white', fontSize:17,textAlign:'left'}}>den in der Reservistenarbeit tätigen Verbänden und Vereinigungen.</Text>
        </View>
